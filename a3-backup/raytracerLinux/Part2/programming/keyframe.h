...
public:
	...
	enum { ROOT_TRANSLATE_X, ROOT_TRANSLATE_Y, ROOT_TRANSLATE_Z,
		   ...
		   HEAD,
		   R_ARM_SCALE,
		   R_SHOULDER_PITCH_p1, R_SHOULDER_YAW_p1,   R_SHOULDER_ROLL_p1,
		   R_SHOULDER_PITCH_p2, R_SHOULDER_YAW_p2,   R_SHOULDER_ROLL_p2,
		   L_ARM_SCALE,
		   L_SHOULDER_PITCH, L_SHOULDER_YAW,   L_SHOULDER_ROLL,
		   R_HIP_PITCH,      R_HIP_YAW,        R_HIP_ROLL,
		   L_HIP_PITCH,      L_HIP_YAW,        L_HIP_ROLL,
		   BEAK,
		   R_ELBOW_X_p1, R_ELBOW_Y_p1, R_ELBOW_Z_p1,
		   R_ELBOW_X_p2, R_ELBOW_Y_p2, R_ELBOW_Z_p2,
		   L_ELBOW_X, L_ELBOW_Y, L_ELBOW_Z,
		   R_KNEE,
		   L_KNEE,
		   LIGHT_HEIGHT,	     LIGHT_RAD,		LIGHT_THETA,
	       NUM_JOINT_ENUM};
